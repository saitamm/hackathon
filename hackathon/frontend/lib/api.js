...
/**
 * Send recorded audio to backend for Groq Whisper Speech-to-Text transcription.
...
/**
 * Speak text using Edge TTS (Microsoft neural voices) via the backend.
 * 100% free, no API key needed, high-quality natural voice.
 *
